...
const pages = {
    ...
    <div class="sd-search-header">
            ...
            <div class="sd-courses">
                <div class="sd-course-card">
                    <img class="sd-image" src="./images/programming.jpeg" alt="">
                    <p class="sd-name">Programming</p>
                    <p class="sd-description">Learn Fundamentals of programming using C++ Learn Fundamentals of programming using C++</p>
                    <p class="sd-instructor">Instructor: Mostafa Saad</p>
                    <div class="sd-progress">
                        <div class="sd-progress-bar">
                            <div class="sd-bar"><div class="sd-fill"></div></div>
                            <p class="sd-percent">50% Complete</p>
                        </div>
